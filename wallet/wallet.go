...
// Đây là một implementation cơ bản của ví cryptocurrency sử dụng cặp khóa bất đối xứng ECDSA.
// Khóa riêng tư dùng để ký các giao dịch, trong khi khóa công khai dùng để tạo địa chỉ ví và xác minh chữ ký.
// Truy xuất khoá riêng
